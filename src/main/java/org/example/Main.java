...
public class Main extends TelegramLongPollingBot {
    ...
    public String getBotToken() {
        return "6281638721:AAFI9WoAxoUgFW0JIW-AawmCiEiM_LpQZxI";
    }
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasCallbackQuery()) {
            if (update.getCallbackQuery().getData().equals("level_1_task") && getLevel(chatId) == 1) {
                ...
                List<String> buttons2 = Arrays.asList(
                ...
                buttons2 = getRandom3(buttons2);

                attachButtons(message, Map.of(
                        buttons2.get(0), "level_2_task",
                        buttons2.get(1), "level_2_task",
                        buttons2.get(2), "level_2_task"
                ));
                sendApiMethodAsync(message);
            }
        }
        ...
        if (update.hasCallbackQuery()) {
            if (update.getCallbackQuery().getData().equals("level_2_task") && getLevel(chatId) == 2) {
                ...
                List<String> buttons3 = Arrays.asList(
                ...
                buttons3 = getRandom3(buttons3);

                attachButtons(message, Map.of(
                        buttons3.get(0), "level_3_task",
                        buttons3.get(1), "level_3_task",
                        buttons3.get(2), "level_3_task"
                ));
    ...
    public void sendImage(String name, Long chatId){
        ...
        inputFile.setMedia(new File("img/" + name + ".gif"));
